...
```bash
git clone [https://github.com/apachematt20/Cipher.git](https://github.com/apachematt20/Cipher.git)
cd Cipher
gcc -O3 Cipher.c -o Cipher
...
Bash
./Cipher <input_file> <output_file> <password>
Examples
...
Bash
./Cipher secret.txt encrypted.bin "MySuperSecretPassword!"
2. Decrypting a file:
...
Bash
./Cipher encrypted.bin decrypted.txt "MySuperSecretPassword!"
```
